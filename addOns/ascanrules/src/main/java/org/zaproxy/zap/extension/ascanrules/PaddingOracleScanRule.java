...
public class PaddingOracleScanRule extends AbstractAppParamPlugin
    ...
    public String getName() {
        return Constant.messages.getString("ascanrules.paddingoracle.name");
    }

    @Override
    public String getDescription() {
        return Constant.messages.getString("ascanrules.paddingoracle.desc");
    }
    ...
    public String getSolution() {
        return Constant.messages.getString("ascanrules.paddingoracle.soln");
    }

    @Override
    public String getReference() {
        return Constant.messages.getString("ascanrules.paddingoracle.refs");
    }
